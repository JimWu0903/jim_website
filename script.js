...
const skillTabsContainer = document.querySelector(".skill__tab-container");
const skillTabsContent = document.querySelectorAll(".skill__content");
...
///////////////////////////////////////
// skill component
skillTabsContainer.addEventListener("click", function (e) {
  ...
  skillTabs.forEach((t) => t.classList.remove("skill__tab--active"));
  skillTabsContent.forEach((c) => c.classList.remove("skill__content--active"));
